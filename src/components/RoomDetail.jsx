    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 flex flex-col items-center justify-center">
        <div className="relative">
          ...
          <div className="absolute inset-0 w-16 h-16 border-4 border-purple-200 border-t-purple-600 rounded-full animate-spin opacity-50" style={{animationDirection: 'reverse', animationDuration: '1.5s'}}></div>
        </div>
        <p className="text-xl text-gray-600 font-medium">Loading room details...</p>
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-white/20">
          ...
          <div className="relative h-96 overflow-hidden">
            ...
            <div className="absolute top-6 right-6 z-20 bg-gradient-to-r from-indigo-600/90 to-purple-600/90 backdrop-blur-md text-white px-6 py-3 rounded-full border border-white/30 shadow-lg">
              <span className="font-bold text-sm uppercase tracking-wider">{room.type}</span>
            </div>
          ...
          <div className="p-8 space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-indigo-50 to-blue-100 rounded-2xl p-6 border border-indigo-200/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-indigo-600 font-semibold text-sm uppercase tracking-wide">Capacity</p>
                    <p className="text-2xl font-bold text-gray-800">{room.capacity} Guests</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-pink-50 to-rose-100 rounded-2xl p-6 border border-pink-200/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-pink-600 font-semibold text-sm uppercase tracking-wide">Price</p>
                    <p className="text-2xl font-bold text-gray-800">${room.price}/night</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              <button className="relative px-12 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-2xl text-xl font-bold shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-1 overflow-hidden group">
